...
- Hover preview: toggle an inline hover preview to show converted values on mouseover in the editor.
- Insert original + converted: inserts `original (converted)` so you can keep both.
- Optional: auto-convert pasted measurements into the active editor (opt-in setting).
...
- Convert input
- Convert selection
- Insert original + converted
- Toggle auto-convert on paste
- Toggle inline conversion previews (hover)
